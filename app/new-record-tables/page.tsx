...
//   await createOrderItems()
  ...
  return <>
  <pre className="text-lg p-10">Action won't work in production<RefreshComponent/></pre>
...
(description, price, quantity_in_stock, last_ordered_date, created_at, updated_at) 
<br/>
...
(username, name, surname, password, annual_leave_allowance, role, salary, created_at) 
<br/>
...
VALUES 
('Fernando Alicante', '123 Main Street', 'email@gmail.com', '555-1234', 100.00, CURRENT_TIMESTAMP);
<br/>
<br/>
...
VALUES 
(4, '2023-02-04', NULL, CURRENT_TIMESTAMP);
...
VALUES 
(1, 1, 'Processing', 150.00, CURRENT_TIMESTAMP);
...
<br/>
(order_item_id, order_id, stock_id, quantity, unit_price, line_total, created_at, updated_at) 
<br/>
VALUES 
(4, 1, 2, 10, 15.00, 150.00, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
</div>
  </>
}
